/**
 *
 * @summary Provider Class for ToolTip Texts
...
function get_tooltip_text(name) {
    // function returns the right tooltip depending on the legend
...
// functions that return the tooltip text in html format
...
function get_tooltip_text_RL() {
    let tooltip_string = <div>
        ...
        <div>The Remediation Level of a vulnerability is adapted from the Common Vulnerability Scoring System v.3.1 (CVSS v3.1)</div>
        <div>Values:
            <ul>
...
function get_tooltip_text_APP() {
    let tooltip_string = <div>
        ...
        <div>This metric evaluates the appropriate grace period with respect to delays which may arise with necessary approval obligations.
